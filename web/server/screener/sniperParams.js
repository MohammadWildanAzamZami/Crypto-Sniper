...
export const PARAM_DEFS = [
  ...
  { key: "minMcap", env: "SNIPER_MIN_MCAP", type: "int", def: 15000, min: 0, max: 1000000, step: 1000,
    group: "Gate", label: "Mcap minimum (USD)",
    hint: "Lantai bawah — buang token terlalu mikro/mati." },
  ...
  { key: "minLockedPct", env: "SNIPER_MIN_LOCKED_PCT", type: "int", def: 0, min: 0, max: 100, step: 5,
